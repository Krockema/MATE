...
{
    class Queuing : SimulationCore.Types.Behaviour
    {

        private FCentralResourceDefinition _resourceDefinition;
        private FCentralActivity _currentActivity;
        public Queuing(FCentralResourceDefinition resourceDefinition, SimulationType simulationType = SimulationType.None)
        ...
        public override bool Action(object message)
        {
            switch (message)
            {
                case Resource.Instruction.Central.ActivityStart msg:
                    StartWork(msg.GetObjectFromMessage);
                    break;
                case Resource.Instruction.Central.ActivityFinish msg:
                    FinishWork();
                    break;
