...
namespace Master40.Controllers
{
    public class SimulationConfigurationsController : Controller
    {
        ...
        {
            return ViewComponent("ProductLeadTime", new List<string> { simId1.ToString(), simType1, "1"});
        }
        ...
        {
            return ViewComponent("ProductLeadTime", new List<string> { simId1.ToString(), simType1,"1" , simId2.ToString(), simType2, "1", simId3.ToString(), simType3, "1" });
        }
        ...
        {
            return ViewComponent("ProductLeadTime", new List<string> { simId1.ToString(), simType1, "1", simId2.ToString(), simType2, "1"});
        }
        ...
        {
            return ViewComponent("ProductLeadTime", new List<string> { simId1.ToString(), simType1, "1", simId2.ToString(), simType2, "1", simId3.ToString(), simType3, "1", simId4.ToString(), simType4, "1"});
        }
