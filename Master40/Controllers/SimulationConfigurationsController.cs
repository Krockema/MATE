...
namespace Master40.Controllers
{
    public class SimulationConfigurationsController : Controller
    {
        ...
        {
            return ViewComponent("ProductLeadTime", new List<string> { simId1.ToString(), simType1});
        }
        ...
        {
            return ViewComponent("ProductLeadTime", new List<string> { simId1.ToString(), simType1 , simId2.ToString(), simType2, simId3.ToString(), simType3});
        }
        ...
        {
            return ViewComponent("ProductLeadTime", new List<string> { simId1.ToString(), simType1, simId2.ToString(), simType2 });
        }
        ...
        {
            return ViewComponent("ProductLeadTime", new List<string> { simId1.ToString(), simType1, simId2.ToString(), simType2, simId3.ToString(), simType3, simId4.ToString(), simType4 });
        }
