...
namespace Mate.DataCore
{
    public static class Dbms
    {
        ...
        public static DataBase<MateProductionDb> GetMateDataBase(bool archive = false, string dbName = "", bool noTracking = true)
        {
            ...
            dataBase.DbContext = new MateProductionDb(
                new DbContextOptionsBuilder<MateDb>()
        ...
        public static DataBase<MateResultDb> GetNewResultDataBase()
        {
            var dbName = Constants.DbWithSuffixResults();
            return GetResultDataBase(dbName);
        }

        public static DataBase<MateResultDb> GetResultDataBase(string dbName)
        {
            DataBase<MateResultDb> dataBase = new DataBase<MateResultDb>(dbName);
            ...
            dataBase.DbContext = new MateResultDb(
                new DbContextOptionsBuilder<MateResultDb>()
                    .UseSqlServer(dataBase.ConnectionString.Value).Options);
