...
{
    public class MateDb : DbContext
    {
        public static MateDb GetContext(string connectionString)
        {
            return new MateDb(options: new DbContextOptionsBuilder<MateDb>()
                .UseSqlServer(connectionString: connectionString)
                .Options);
        }
        public MateDb(DbContextOptions<MateDb> options) : base(options: options) { }
        [JsonIgnore]
