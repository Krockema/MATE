...
namespace Mate.DataCore.Data.Initializer.Tables
{
    ...
    {
        public void Init(MateDb context, MasterTableBusinessPartner businessPartner, MasterTableArticle article)
        {
            var artToBusinessPartner = new M_ArticleToBusinessPartner[]
            {
                new M_ArticleToBusinessPartner
                {
                    ...
                    TimeToDelivery = TimeSpan.FromMinutes(2880)
                },
                new M_ArticleToBusinessPartner
                {
                    BusinessPartnerId = businessPartner.KREDITOR_MATERIAL_WHOLSALE.Id,
                ...
                new M_ArticleToBusinessPartner
                {
                    ...
                    Price = 20.00, TimeToDelivery = TimeSpan.FromMinutes(2880)
                },
                new M_ArticleToBusinessPartner
                {
                    BusinessPartnerId = businessPartner.KREDITOR_MATERIAL_WHOLSALE.Id,
                    ArticleId = article.CHASSIS_TYPE_RACE.Id, PackSize = 10,
                    Price = 25.00, TimeToDelivery = TimeSpan.FromMinutes(2880)
                },
                new M_ArticleToBusinessPartner
                {
                    BusinessPartnerId = businessPartner.KREDITOR_MATERIAL_WHOLSALE.Id,
                ...
                new M_ArticleToBusinessPartner
                {
                    ...
                    Price = 0.40, TimeToDelivery = TimeSpan.FromMinutes(1440)
                },
                new M_ArticleToBusinessPartner
                {
                    BusinessPartnerId = businessPartner.KREDITOR_MATERIAL_WHOLSALE.Id,
                    ArticleId = article.ENGINE_RACE_EXTENSION.Id, PackSize = 10,
                    Price = 1.00, TimeToDelivery = TimeSpan.FromMinutes(1440)
                },
                new M_ArticleToBusinessPartner
                {
                    BusinessPartnerId = businessPartner.KREDITOR_MATERIAL_WHOLSALE.Id,
                    ArticleId = article.SIDEWALL_LONG.Id, PackSize = 10,
                    Price = 0.55, TimeToDelivery = TimeSpan.FromMinutes(1440)
                },
                new M_ArticleToBusinessPartner
                {
                    BusinessPartnerId = businessPartner.KREDITOR_MATERIAL_WHOLSALE.Id,
                    ArticleId = article.SIDEWALL_SHORT.Id, PackSize = 10,
                    Price = 0.45, TimeToDelivery = TimeSpan.FromMinutes(1440)
                },
                new M_ArticleToBusinessPartner
                {
                    BusinessPartnerId = businessPartner.KREDITOR_MATERIAL_WHOLSALE.Id,
                ...
                new M_ArticleToBusinessPartner
                {
                    ...
                    PackSize = 50, Price = 0.90, TimeToDelivery = TimeSpan.FromMinutes(1440)
                },
                new M_ArticleToBusinessPartner
                {
                    BusinessPartnerId = businessPartner.KREDITOR_MATERIAL_WHOLSALE.Id,
                ...
                new M_ArticleToBusinessPartner
                {
                    ...
                    Price = 0.10, TimeToDelivery = TimeSpan.FromMinutes(1440)
                },
                new M_ArticleToBusinessPartner
                {
                    BusinessPartnerId = businessPartner.KREDITOR_MATERIAL_WHOLSALE.Id,
                ...
                new M_ArticleToBusinessPartner
                {
                    ...
                    PackSize = 100, Price = 0.20, TimeToDelivery = TimeSpan.FromMinutes(1440)
                },
                new M_ArticleToBusinessPartner
                {
                    BusinessPartnerId = businessPartner.KREDITOR_MATERIAL_WHOLSALE.Id,
                ...
                new M_ArticleToBusinessPartner
                {
                    ...
                    Price = 0.20, TimeToDelivery = TimeSpan.FromMinutes(1440)
                },
