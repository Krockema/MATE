...
namespace Mate.DataCore.Data.Helper
{
    public static class DbUtils
    {
        ...
        public static void InsertOrUpdateRange<TEntity>(IEnumerable<TEntity> entities,
            DbSet<TEntity> dbSet, MateDb masterDBContext) where TEntity : BaseEntity
        {
        ...
        public static void InsertOrUpdate<TEntity>(TEntity entity, DbSet<TEntity> dbSet, MateDb masterDBContext)
