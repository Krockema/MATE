...
namespace Mate.Production.Core.Agents.JobAgent
{
    public partial class Job
    {
        public record Instruction
        {
            ...
            {
                public static AcknowledgeJob Create(JobResourceConfirmationRecord message,IActorRef target)
                {
                ...
                { }
                public JobResourceConfirmationRecord GetObjectFromMessage { get => Message as JobResourceConfirmationRecord; }
            }
