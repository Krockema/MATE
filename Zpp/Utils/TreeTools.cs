...
namespace Zpp.Utils
{
    public static class TreeTools<TEntity>
    {
        ...
        /// </returns>
        public static List<Node<TEntity>> traverseDepthFirst(ITree<TEntity> tree,
            Action<Node<TEntity>> action)
        {
         ...
         */
        public static string AdjacencyListToString(
            IDictionary<int, List<TEntity>> _adjacencyList)
        {
            string myString = "";
