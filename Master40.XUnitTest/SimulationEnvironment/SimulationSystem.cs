...
namespace Master40.XUnitTest.SimulationEnvironment
{
    public class SimulationSystem : TestKit
    {
        ...
        [InlineData(SimulationType.BucketScope, 76, 480, 1920, 169, ModelSize.Large, ModelSize.Small, 0.05, true)]
        [InlineData(SimulationType.BucketScope, 77, 480, 1920, 169, ModelSize.Large, ModelSize.Medium, 0.05, true)]
        [InlineData(SimulationType.BucketScope, 78, 480, 1920, 169, ModelSize.Large, ModelSize.Large, 0.05, true)]
