...
namespace Master40.XUnitTest.SimulationEnvironment
{
    public class SimulationSystem : TestKit
    {
        ...
        [InlineData(SimulationType.BucketScope, 163, 1440, 1920, 169, ModelSize.Medium, ModelSize.Small, 0.025, false)]
        [InlineData(SimulationType.BucketScope, 164, 1440, 1920, 169, ModelSize.Medium, ModelSize.Medium, 0.025, false)]
        [InlineData(SimulationType.BucketScope, 165, 1440, 1920, 169, ModelSize.Medium, ModelSize.Large, 0.025, false)]
        [InlineData(SimulationType.BucketScope, 166, 1440, 1920, 169, ModelSize.Large, ModelSize.Small, 0.04, false)]
        [InlineData(SimulationType.BucketScope, 167, 1440, 1920, 169, ModelSize.Large, ModelSize.Medium, 0.04, false)]
        [InlineData(SimulationType.BucketScope, 168, 1440, 1920, 169, ModelSize.Large, ModelSize.Large, 0.04, false)]
