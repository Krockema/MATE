...
namespace Master40.XUnitTest.Zpp.Unit_Tests
{
    public class TestStackSet
    {
        ...
        public void TestAdd()
        {
            ...
            stackSet.Push(testNumber);
            Assert.True((bool) stackSet.Count().Equals(testNumber), "Set contains a duplicate.");
            Assert.True((bool) stackSet.PopAny().Equals(testNumber), "Value was not correctly added.");
        }
        ...
        {
            IStackSet<int> stackSet = new StackSet<int>();
            Assert.False((bool) stackSet.Any(), "Set should not contain any.");

            int testNumber = 1;
            stackSet.Push(testNumber);
            Assert.True((bool) stackSet.Any(), "Set should contain any.");
        }
        ...
        public void TestCount()
        {
            ...
            stackSet.Push(testNumber2);
            Assert.True(
                (bool) stackSet.Count().Equals(2), "PopAny didn't work.");
        }
    }
}