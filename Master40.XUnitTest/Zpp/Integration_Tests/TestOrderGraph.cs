...
namespace Master40.XUnitTest.Zpp.Integration_Tests
{
    public class TestOrderGraph : AbstractTest
    {
        ...
        public void TestAllEdgesAreInOrderGraph(string testConfigurationFileName)
        {
            ...
            Assert.True((bool) orderDirectedGraph.GetAllHeadNodes().Any(),
                "There are no toNodes in the orderGraph.");

            int sumDemandToProviderAndProviderToDemand =
                Enumerable.Count<T_DemandToProvider>(dbTransactionData.DemandToProviderGetAll()) +
                Enumerable.Count<T_ProviderToDemand>(dbTransactionData.ProviderToDemandGetAll());
        ...
        public void TestOrderGraphStaysTheSame(string testConfigurationFileName)
        {
            ...
            string orderGraphFileName =
                $"../../../Zpp/Ordergraphs/demandToProvider_graph_{TestConfiguration.Name}.txt";
            string orderGraphFileNameWithIds =
                $"../../../Zpp/Ordergraphs/demandToProvider_graph_{TestConfiguration.Name}_with_ids.txt";
