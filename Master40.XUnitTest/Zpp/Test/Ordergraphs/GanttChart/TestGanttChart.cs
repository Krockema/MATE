using System.IO;
using System.Text;
using Master40.XUnitTest.Zpp.Test.Configuration;
using Xunit;
using Zpp.DbCache;
using Zpp.Mrp;
using Zpp.Utils;

namespace Master40.XUnitTest.Zpp.Test.Ordergraphs.GanttChart
{
    public class TestGanttChart : AbstractTest
    {
        ...
        public void TestGanttChartBar(string testConfigurationFileName)
        {
            ...
            string orderGraphAsGanttChartFile =
                $"../../../Zpp/Test/Ordergraphs/GanttChart/gantt_chart_{TestConfiguration.Name}.json";
            ...
            string actualGanttChart = new global::Zpp.GraphicalRepresentation.GanttChart(dbTransactionData.ProductionOrderOperationGetAll(), dbMasterDataCache).ToString();
