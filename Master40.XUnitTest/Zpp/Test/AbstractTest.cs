...
using Master40.XUnitTest.Zpp.Test.Configuration.Scenarios;
using Microsoft.EntityFrameworkCore;
using Newtonsoft.Json;
using Zpp.DbCache;
using Zpp.Utils;

namespace Master40.XUnitTest.Zpp.Test
{
    /**
    ...
    public abstract class AbstractTest : IDisposable
    {
        ...
        protected void InitDb(string testConfiguration)
        {
            ...
            global::Zpp.LotSize.LotSize.SetDefaultLotSize(new Quantity(TestConfiguration.LotSize));
            global::Zpp.LotSize.LotSize.SetLotSizeType(TestConfiguration.LotSizeType);
        }
