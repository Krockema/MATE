...
// General wQchart configuration
wQchart.base = function() {
    ...
    function _plot(data) {
        ...
        // Outer wQchart area (includes legends, axes & actual graph)
    ...
    // Getters/setters for wQchart configuration
...
// Scatter plot
wQchart.scatter = function() {
    var plot = wQchart.base(), pointStyle = plot.circleStyle(), pointShape;
...
wQchart.timeSeries = function() {
    var plot = wQchart.scatter(),
...
wQchart.boxplot = function() {
    var plot = wQchart.base(), r, wr, offsets = {}, prefix = 'value-';
