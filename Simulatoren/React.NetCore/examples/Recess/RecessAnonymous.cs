//=============================================================================
//=  $Id: RecessAnonymous.cs 128 2005-12-04 20:12:00Z Eric Roe $
//=
...
public class RecessAnonymous : Simulation
{
    ...
    private RecessAnonymous()
    {
        _thwacker = Resource.Create(3);
    }
    ...
    public static void Main(string[] args)
    {
        ...
        RecessAnonymous p = new RecessAnonymous();
     ...
     * 
     *        yield return new ReleaseResource(this, _thwacker);
     */
}