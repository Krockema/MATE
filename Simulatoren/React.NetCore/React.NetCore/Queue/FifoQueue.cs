//=============================================================================
//=  $Id: FifoQueue.cs 182 2006-10-14 17:51:51Z eroe $
//=
...
{
	/// <summary>
	/// A first-in, first-out <see cref="IQueue&lt;T&gt;"/> implementation.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
    /// <typeparam name="T">
    /// The type of object to store in the <see cref="FifoQueue&lt;T&gt;"/>.
    /// </typeparam>
    [
    ...
    public class FifoQueue<T> : Collection<T>, IQueue<T>
	{
		/// <summary>
        /// Create a new, empty <see cref="FifoQueue&lt;T&gt;"/> instance.
		/// </summary>
		public FifoQueue()
		{
		}
        ...
        /// If the <see cref="FifoQueue&lt;T&gt;"/> is empty.
		/// </exception>
		/// <returns>
        /// The item at the front of the <see cref="FifoQueue&lt;T&gt;"/>.
		/// </returns>
		public T Dequeue()
		{
			T item = Peek();
		...
		/// <summary>
        /// Gets the item at the front of the <see cref="FifoQueue&lt;T&gt;"/>.
		/// </summary>
		/// <remarks>
		/// The item at the front of the queue is returned, but is not removed
        /// from the <see cref="FifoQueue&lt;T&gt;"/>
		/// </remarks>
		/// <exception cref="InvalidOperationException">
        /// If the <see cref="FifoQueue&lt;T&gt;"/> is empty.
		/// </exception>
