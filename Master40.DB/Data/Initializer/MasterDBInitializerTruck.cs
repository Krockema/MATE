        ...
        public static void DbInitialize(MasterDBContext context)
        {
            ...
            var resourceSkills = new M_ResourceSkill[]
           {
            ...
            var articles = new M_Article[]
            {
                ...
                // Chassies
                new M_Article{Name="Cabin", ArticleTypeId = articleTypes.Single( predicate: s => s.Name == "Material").Id, CreationDate = DateTime.Parse(s: "2002-09-01"), DeliveryPeriod = 10, UnitId = units.Single( predicate: s => s.Name == "Pieces").Id, Price = 1.75, ToPurchase = false, ToBuild = true},
                new M_Article{Name="Engine-Block", ArticleTypeId = articleTypes.Single( predicate: s => s.Name == "Material").Id, CreationDate = DateTime.Parse(s: "2002-09-01"), DeliveryPeriod = 10, UnitId = units.Single( predicate: s => s.Name == "Pieces").Id, Price = 3.00, ToPurchase = false, ToBuild = true},
                
                // Truck Bed
                new M_Article{Name="Side wall long", ArticleTypeId = articleTypes.Single( predicate: s => s.Name == "Material").Id, CreationDate = DateTime.Parse(s: "2002-09-01"), DeliveryPeriod = 10, UnitId = units.Single( predicate: s => s.Name == "Pieces").Id, Price = 0.35, ToPurchase = false, ToBuild = true},
                new M_Article{Name="Side wall short", ArticleTypeId = articleTypes.Single( predicate: s => s.Name == "Material").Id, CreationDate = DateTime.Parse(s: "2002-09-01"), DeliveryPeriod = 10, UnitId = units.Single( predicate: s => s.Name == "Pieces").Id, Price = 0.25, ToPurchase = false, ToBuild = true},
                new M_Article{Name="Base plate Truck-Bed", ArticleTypeId = articleTypes.Single( predicate: s => s.Name == "Material").Id, CreationDate = DateTime.Parse(s: "2002-09-01"), DeliveryPeriod = 10, UnitId = units.Single( predicate: s => s.Name == "Pieces").Id, Price = 0.40, ToPurchase = false, ToBuild = true},
                ...
                new M_Article{Name="Engine Race Extension", ArticleTypeId = articleTypes.Single( predicate: s => s.Name == "Material").Id, CreationDate = DateTime.Parse(s: "2002-09-01"), DeliveryPeriod = 10, UnitId = units.Single( predicate: s => s.Name == "Pieces").Id, Price = 0.50, ToPurchase = false, ToBuild = true},
                // Skeleton
                ...
                new M_Article{Name="Base plate", ArticleTypeId = articleTypes.Single( predicate: s => s.Name == "Material").Id, CreationDate = DateTime.Parse(s: "2002-09-01"), DeliveryPeriod = 10, UnitId = units.Single( predicate: s => s.Name == "Pieces").Id, Price = 0.80, ToPurchase = false, ToBuild = true},
            ...
            var articleBom = new List<M_ArticleBom>
            {
                ...
                new M_ArticleBom { ArticleChildId = articles.Single(predicate: a => a.Name == "Button").Id, Name = "Knop", Quantity=2, ArticleParentId = articles.Single(predicate: a => a.Name == "Dump-Truck").Id, OperationId = operations.Single(predicate: x => x.Name == "Glue Truck-Bed").Id },
                ...
                new M_ArticleBom { ArticleChildId = articles.Single(predicate: a => a.Name == "Button").Id, Name = "Knop", Quantity=2, ArticleParentId = articles.Single(predicate: a => a.Name == "Race-Truck").Id, OperationId = operations.Single(predicate: x => x.Name == "Glue Race Wing").Id },
                ...
                new M_ArticleBom { ArticleChildId = articles.Single(predicate: a => a.Name == "Button").Id, Name = "Knop", Quantity=2, ArticleParentId = articles.Single(predicate: a => a.Name == "Chassis Type: Dump").Id, OperationId = operations.Single(predicate: x => x.Name == "Dump-Truck: Assemble Lamps").Id },
                ...
                new M_ArticleBom { ArticleChildId = articles.Single(predicate: a => a.Name == "Button").Id, Name = "Knop", Quantity=2, ArticleParentId = articles.Single(predicate: a => a.Name == "Chassis Type: Race").Id, OperationId = operations.Single(predicate: x => x.Name == "Race-Truck: Assemble Lamps").Id },
                ...
                new M_ArticleBom { ArticleChildId = articles.Single(predicate: a => a.Name == "Side wall short").Id, Name = "Side wall short", Quantity=1, ArticleParentId = articles.Single(predicate: a => a.Name == "Truck-Bed").Id, OperationId = operations.Single(predicate: x => x.Name == "Glue side walls and base plate together").Id },
                ...
                new M_ArticleBom { ArticleChildId = articles.Single(predicate: a => a.Name == "Side wall short").Id, Name = "Side wall short", Quantity=1, ArticleParentId = articles.Single(predicate: a => a.Name == "Truck-Bed").Id, OperationId = operations.Single(predicate: x => x.Name == "Mount hatchback").Id },
                ...
                new M_ArticleBom { ArticleChildId = articles.Single(predicate: a => a.Name == "Button").Id, Name = "Knop", Quantity=2, ArticleParentId = articles.Single(predicate: a => a.Name == "Truck-Bed").Id, OperationId = operations.Single(predicate: x => x.Name == "Mount hatchback").Id },
            ...
            {
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Skeleton").Id,PackSize = 10,Price = 20.00, DueTime = 2880},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Truck-Bed").Id,PackSize = 10,Price = 20.00, DueTime = 2880},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Chassis Type: Dump").Id, PackSize = 10,Price = 20.00, DueTime = 2880},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Chassis Type: Race").Id, PackSize = 10,Price = 25.00, DueTime = 2880},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Cabin").Id,PackSize = 10,Price = 1.75, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Engine-Block").Id, PackSize = 10,Price = 0.40, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Engine Race Extension").Id, PackSize = 10,Price = 1.00, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Side wall long").Id,PackSize = 10,Price = 0.55, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Side wall short").Id,PackSize = 10,Price = 0.45, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Base plate Truck-Bed").Id, PackSize = 10,Price = 0.40, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Dump Joint").Id /*Kippgelenk*/,PackSize = 50,Price = 0.90, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Wheel").Id, PackSize = 150,Price = 0.35, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Base plate").Id, PackSize = 10,Price = 0.80, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Semitrailer" /*Aufleger*/).Id, PackSize = 25,Price = 0.10, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Race Wing").Id, PackSize = 10,Price = 1.50, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Washer").Id,PackSize = 150,Price = 0.02, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Timber Plate 1,5m x 3,0m").Id, PackSize = 100,Price = 0.20, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Timber Block 0,20m x 0,20m").Id, PackSize = 100,Price = 0.20, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Glue").Id, PackSize = 1000,Price = 0.01, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Pegs").Id, PackSize = 200,Price = 0.01, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Pole").Id, PackSize = 200,Price = 0.25, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Button").Id, PackSize = 500,Price = 0.05, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="Packing").Id, PackSize = 50,Price = 2.50, DueTime = 1440},
                new M_ArticleToBusinessPartner{ BusinessPartnerId = businessPartner2.Id, ArticleId = articles.Single(predicate: x => x.Name=="User Manual").Id, PackSize = 50,Price = 0.20, DueTime = 1440},
