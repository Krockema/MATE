...
{
    public class T_Provider : BaseEntity, IDemandToProvider
    {
        ...
        [JsonIgnore]
        public T_Demand DemandRequester { get; set; }
        [JsonIgnore]
        public virtual List<T_Demand> DemandProvider { get; set; }
    ...
    public class ProviderStock : T_Demand
    {
    ...
    public class ProviderPurchasePart : T_Demand
    {
    ...
    public class ProviderProductionOrder : T_Demand
    {
