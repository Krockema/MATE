...
namespace Master40.DB.DataTransformation
{
    ...
    /// </summary>
    public class GanttPlanApi
    {
        private const string PATH_TO_GANTTPLAN = @"C:\Program Files\GANTTPLAN\gpDll.dll";

        [DllImport(PATH_TO_GANTTPLAN, EntryPoint = "GPGetVersion", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(PATH_TO_GANTTPLAN, CallingConvention = CallingConvention.Cdecl)]
